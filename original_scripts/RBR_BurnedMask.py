...
if Sensor == 0:  
    print('Sentinel')
    # Path='/media/gonzalo/ALMACEN/Sentinel/'
    Path='/home/tonio-bc/EOData/PostProcessing/sdrs/'
    ...
    ScaleFactor=0.0001
    Version='_3'
    PathIndex=Fold('/home/tonio-bc/EOData/PostProcessing/orig_output/RBR_BurnedMask'+Version)
